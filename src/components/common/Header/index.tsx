...
export default function Header() {
  return (
    <>
      {/* 데스크톱 헤더 */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-white hidden sm:block pt-[60px]">
      ...
      {/* 모바일 헤더 */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-white sm:hidden pt-[60px]">
        <div className="max-w-7xl mx-auto">
          <div className="mx-4">
